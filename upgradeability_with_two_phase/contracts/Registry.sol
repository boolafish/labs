...
contract Registry is IRegistry {
  ...
  mapping (address => string) internal overrides;
  ...
  */
  ...
  function overrideUserToVersion(address user, string version) public {
    overrides[user] = version;
  }

  function removeOverrideUserToVersion(address user) public {
    delete overrides[user];
  }

  function getOverrideVersionOfUser(address user) public view returns (address) {
    return versions[overrides[user]];
  }
}
